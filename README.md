...
## Install  
$${\color{To successfully install iLOSCAR, please follow the tutorial provided. Note that the 'pip' command installation method is not effective in this case.}Red}$$
