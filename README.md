...
Five inversion options are provided in the inverse model. The aim of the inverse model is to derive the time-dependent carbon emission scenario ($f\delta^{13}C(t))$) and the isotopic composition of emitted carbon ( $f\delta^{13}C(t))$ by minimizing the relative errors between observations and corresponding modeling results:  
