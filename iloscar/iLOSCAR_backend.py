...
from scipy.optimize import fmin_l_bfgs_b, fmin, fminbound, brent, root_scalar
...
def model_run(set_progress):
    ...
    if RUN_TYPE == 1:
        ...
        t_eval = np.loadtxt('tmv.dat')
        ysol = solve_ivp(derivs, (t0, tfinal), ystart, t_eval = t_eval, args = [set_progress, hpls], method = 'LSODA')
